...
//  InstagramFirebase
//
//  Created by Jushy Shen on 2018/9/26.
...
class CameraController: UIViewController, AVCapturePhotoCaptureDelegate, UIViewControllerTransitioningDelegate {
    ...
    let customAnimationPresentor = CustumAnimationPresentor()
    let customAnimationDismisser = CustumAnimationDismisser()
...
//        previewImageView.anchor(top: view.topAnchor, left: view.leftAnchor, bottom: view.bottomAnchor, right: view.rightAnchor, paddingTop: 0, paddinfLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 0)
