...
//  InstagramFirebase
//
//  Created by Jushy Shen on 2018/8/8.
...
//                print(snapshot.key)
    ...
    fileprivate func fetchOrderPosts() {
        ...
        //prehaps later on we'll implement some pagination of data
 ...
 //           self.posts.append(post)
            ...
            print("Failed to fetch order posts:", err)
        }
    }
    ...
    @objc func handleLogOut() {
        ...
        alertController.addAction(UIAlertAction(title: "Log Out", style: .destructive, handler: { (_) in
            do {
                ...
                // what happen? we need to present some kind of login controller
